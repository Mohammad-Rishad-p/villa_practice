    ...
    return (
        ...
        <div className='bg-white flex items-center justify-between'>
            ...
            <div className='pl-32 my-4'>
                <h1 onClick={()=>setfirst(first+1)} className='text-4xl'>Villa {first}</h1>
            </div>
            ...
            <div className='flex gap-6 pr-16'>
                ...
                <button className='flex gap-1 items-center bg-black rounded-full'>
                    <svg className='text-white bg-red-500 p-2 rounded-full' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 bg-red-500 rounded-full text-white p-[2px] ">
